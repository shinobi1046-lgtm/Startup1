...
// Auto-generated API client for Qualtrics integration

import { BaseAPIClient } from './BaseAPIClient';

export interface QualtricsAPIClientConfig {
  apiKey: string;
  baseUrl?: string;
}

export class QualtricsAPIClient extends BaseAPIClient {
  protected baseUrl: string;
  private config: QualtricsAPIClientConfig;

  constructor(config: QualtricsAPIClientConfig) {
    super();
    this.config = config;
    this.baseUrl = config.baseUrl || 'https://{{datacenter}}.qualtrics.com/API/v3';
  }
