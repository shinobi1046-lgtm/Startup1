// POWER BI ENHANCED API CLIENT
// Auto-generated API client for Power BI Enhanced integration

import { BaseAPIClient } from './BaseAPIClient';

export interface PowerbiEnhancedAPIClientConfig {
  accessToken: string;
  refreshToken?: string;
  clientId?: string;
  clientSecret?: string;
...
export class PowerbiEnhancedAPIClient extends BaseAPIClient {
  protected baseUrl: string;
  private config: PowerbiEnhancedAPIClientConfig;

  constructor(config: PowerbiEnhancedAPIClientConfig) {
    super();
    this.config = config;
  ...
  /**
   * Create a new record in Power BI Enhanced
   */
  ...
  /**
   * Update an existing record in Power BI Enhanced
   */
  ...
  /**
   * Retrieve a record from Power BI Enhanced
   */
  ...
  /**
   * List records from Power BI Enhanced
   */
  ...
  /**
   * Delete a record from Power BI Enhanced
   */
  ...
  /**
   * Poll for Triggered when a new record is created in Power BI Enhanced
   */
  ...
  /**
   * Poll for Triggered when a record is updated in Power BI Enhanced
   */
