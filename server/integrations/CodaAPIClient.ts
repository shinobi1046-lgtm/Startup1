// CODA API CLIENT
// Auto-generated API client for Coda integration

import { BaseAPIClient } from './BaseAPIClient';

export interface CodaAPIClientConfig {
  apiKey: string;
  baseUrl?: string;
}

export class CodaAPIClient extends BaseAPIClient {
  protected baseUrl: string;
  private config: CodaAPIClientConfig;

  constructor(config: CodaAPIClientConfig) {
    super();
    this.config = config;
