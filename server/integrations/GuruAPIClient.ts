// GURU API CLIENT
// Auto-generated API client for Guru integration

import { BaseAPIClient } from './BaseAPIClient';

export interface GuruAPIClientConfig {
  accessToken: string;
  baseUrl?: string;
}

export class GuruAPIClient extends BaseAPIClient {
  protected baseUrl: string;
  private config: GuruAPIClientConfig;

  constructor(config: GuruAPIClientConfig) {
    super();
    this.config = config;
    this.baseUrl = config.baseUrl || 'https://api.getguru.com/api/v1';
  }
