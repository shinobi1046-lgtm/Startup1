...
// Auto-generated API client for Workfront integration

import { BaseAPIClient } from './BaseAPIClient';

export interface WorkfrontAPIClientConfig {
  accessToken: string;
  refreshToken?: string;
  clientId?: string;
  clientSecret?: string;
...
export class WorkfrontAPIClient extends BaseAPIClient {
  protected baseUrl: string;
  private config: WorkfrontAPIClientConfig;

  constructor(config: WorkfrontAPIClientConfig) {
    super();
    this.config = config;
  ...
  /**
   * Create a new record in Workfront
   */
  ...
  /**
   * Update an existing record in Workfront
   */
  ...
  /**
   * Retrieve a record from Workfront
   */
  ...
  /**
   * Delete a record from Workfront
   */
  ...
  /**
   * Poll for Triggered when a new record is created in Workfront
   */
  ...
  /**
   * Poll for Triggered when a record is updated in Workfront
   */
