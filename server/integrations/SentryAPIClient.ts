// SENTRY API CLIENT
// Auto-generated API client for Sentry integration
...
export class SentryAPIClient extends BaseAPIClient {
  ...
  private config: SentryAPIClientConfig;
  ...
  /**
   * Update an existing record in Sentry
   */
  ...
  /**
   * Poll for Triggered when a new record is created in Sentry
   */
  ...
  /**
   * Poll for Triggered when a record is updated in Sentry
   */
