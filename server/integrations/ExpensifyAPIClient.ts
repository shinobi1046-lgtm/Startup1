...
// Auto-generated API client for Expensify integration

import { BaseAPIClient } from './BaseAPIClient';

export interface ExpensifyAPIClientConfig {
  apiKey: string;
  baseUrl?: string;
}

export class ExpensifyAPIClient extends BaseAPIClient {
  protected baseUrl: string;
  private config: ExpensifyAPIClientConfig;

  constructor(config: ExpensifyAPIClientConfig) {
    super();
    this.config = config;
