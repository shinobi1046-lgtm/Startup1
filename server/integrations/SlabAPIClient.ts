// SLAB API CLIENT
// Auto-generated API client for Slab integration

import { BaseAPIClient } from './BaseAPIClient';

export interface SlabAPIClientConfig {
  apiKey: string;
  baseUrl?: string;
}

export class SlabAPIClient extends BaseAPIClient {
  protected baseUrl: string;
  private config: SlabAPIClientConfig;

  constructor(config: SlabAPIClientConfig) {
    super();
    this.config = config;
    this.baseUrl = config.baseUrl || 'https://api.slab.com/v1';
  }
