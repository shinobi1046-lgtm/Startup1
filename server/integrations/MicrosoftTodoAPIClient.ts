...
// Auto-generated API client for Microsoft To Do integration

import { BaseAPIClient } from './BaseAPIClient';

export interface MicrosoftTodoAPIClientConfig {
  accessToken: string;
  refreshToken?: string;
  clientId?: string;
  clientSecret?: string;
...
export class MicrosoftTodoAPIClient extends BaseAPIClient {
  protected baseUrl: string;
  private config: MicrosoftTodoAPIClientConfig;

  constructor(config: MicrosoftTodoAPIClientConfig) {
    super();
    this.config = config;
  ...
  /**
   * Create a new record in Microsoft To Do
   */
  ...
  /**
   * Update an existing record in Microsoft To Do
   */
  ...
  /**
   * Retrieve a record from Microsoft To Do
   */
  ...
  /**
   * List records from Microsoft To Do
   */
  ...
  /**
   * Delete a record from Microsoft To Do
   */
  ...
  /**
   * Poll for Triggered when a new record is created in Microsoft To Do
   */
  ...
  /**
   * Poll for Triggered when a record is updated in Microsoft To Do
   */
