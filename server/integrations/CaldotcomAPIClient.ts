// CAL.COM API CLIENT
// Auto-generated API client for Cal.com integration

import { BaseAPIClient } from './BaseAPIClient';

export interface CaldotcomAPIClientConfig {
  apiKey: string;
  baseUrl?: string;
}

export class CaldotcomAPIClient extends BaseAPIClient {
  protected baseUrl: string;
  private config: CaldotcomAPIClientConfig;

  constructor(config: CaldotcomAPIClientConfig) {
    super();
    this.config = config;
