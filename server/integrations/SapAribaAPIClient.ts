...
// Auto-generated API client for SAP Ariba integration

import { BaseAPIClient } from './BaseAPIClient';

export interface SapAribaAPIClientConfig {
  accessToken: string;
  refreshToken?: string;
  clientId?: string;
  clientSecret?: string;
...
export class SapAribaAPIClient extends BaseAPIClient {
  protected baseUrl: string;
  private config: SapAribaAPIClientConfig;

  constructor(config: SapAribaAPIClientConfig) {
    super();
    this.config = config;
  ...
  /**
   * Create a new record in SAP Ariba
   */
  ...
  /**
   * Update an existing record in SAP Ariba
   */
  ...
  /**
   * Retrieve a record from SAP Ariba
   */
  ...
  /**
   * Delete a record from SAP Ariba
   */
  ...
  /**
   * Poll for Triggered when a new record is created in SAP Ariba
   */
  ...
  /**
   * Poll for Triggered when a record is updated in SAP Ariba
   */
