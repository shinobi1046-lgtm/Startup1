...
// Auto-generated API client for SurveyMonkey integration

import { BaseAPIClient } from './BaseAPIClient';

export interface SurveymonkeyAPIClientConfig {
  accessToken: string;
  baseUrl?: string;
}

export class SurveymonkeyAPIClient extends BaseAPIClient {
  protected baseUrl: string;
  private config: SurveymonkeyAPIClientConfig;

  constructor(config: SurveymonkeyAPIClientConfig) {
    super();
    this.config = config;
